...
### Deployment Outputs
- **MLIP-2 model**: `2xe_cc3_tba_new-deployed_vf.pth` (to be found in the [Zenodo](https://doi.org/10.5281/zenodo.17105321) repository as `3-2xe_cc3_tba_new-deployed_vf.pth.tar.bz2`)
